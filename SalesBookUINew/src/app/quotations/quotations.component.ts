...
export class QuotationsComponent implements OnInit {
    ...
    constructor(
        ...
        private __quotationsService: QuotationsService,
    ...
    getItems() {
        this.getItemSub = this.__quotationsService.getData(this.query)
            .subscribe(data => {
    ...
    deleteItem(row) {
        if (confirm(`Delete ${row.ProductName}?`)) {
            ...
            // this.loader.open();
            this.__quotationsService.deleteData(row)
  ...
  public addEditSales(salesCode) {
      this.__route.navigate(['/quotAddEdit', btoa(salesCode)])
    }
  ...
  public DownloadInvoice(obj) {
      ...
      this.__quotationsService.GetInvoiceReport(SndObject).subscribe(RtnData => {
